...
// --- Data Model ---
        ...
        function calculate() {
            ...
            // Gross customer fee = operator margin + the agent fee cost. For CAD
            // collections, convert the USD agent fee at the active calculation rate.
            const totalFeeCurrency = sendCurrency === 'CAD' ? 'CAD' : 'USD';
            const agentFeeInCollectionCurrency = sendCurrency === 'CAD' ? fee * rate : fee;
            const totalFeeApplied = roundToTwo(profit + agentFeeInCollectionCurrency);
